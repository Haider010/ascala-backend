...
- Summarize and apply it honestly.
- Do not pretend you saw anything that is not present in the retrieved context.
- If the retrieved context is thin or missing, ask the user to paste or upload the content.
...
<!-- ASCALA_PATCH_START type="molly_strategic_foundation" target="section_path_here" mode="replace" -->
